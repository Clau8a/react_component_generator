        ...
        {params
          ...
          .map((param) => (
            <label>
              &nbsp;&nbsp;
              {`${param.name}: ${
                typeOption.find((p) => p.id === parseInt(param.type, 10))
                  .defaultValue
              },`}
            </label>
          ))}
        ...
        {params.map((param) => (
          <label>
            ...
            {`${param.name}: PropTypes.${
              typeOption.find((p) => p.id === parseInt(param.type, 10)).name
        ...
        <div className="row">
                ...
                <div className="form-group form-check">
                  <input
                    ...
                    onChange={() =>
                      handleChange({
                        target: {
                          name: "use_defaultprops",
                          value: !useDefaultProps,
                        },
                      })
                    }
                  />
          ...
          <div className="col-12 col-md-6">
            <div className="card">
              ...
              <div className="card-body">{formatCompilado()}</div>
